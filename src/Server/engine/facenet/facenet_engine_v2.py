...
if __name__ == "__main__":
    ...
    # file_path = "../../dataset/train/japanese/erika-sawajiri/erika-sawajiri1.jpg"
    # embed = face_net_eval.make_encode(filez_path)
    # a = embed.reshape(embed.shape[1],1)
    # b = embed.flatten()
    # print(b.tolist())

    # p = face_net_eval.predict(file_path)
    # print(p)
    # face_net_eval.train()
